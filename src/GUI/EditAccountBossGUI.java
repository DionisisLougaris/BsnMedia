...
public class EditAccountBossGUI {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EditAccountBossGUI window = new EditAccountBossGUI();
	...
	private void initialize() {
		...
		JLabel lblNewLabel_14 = new JLabel("Change Company Verification Code");
		lblNewLabel_14.setFont(new Font("Tahoma", Font.PLAIN, 22));
		lblNewLabel_14.setBounds(12, 553, 382, 33);
		frame.getContentPane().add(lblNewLabel_14);
		
		textField_12 = new JTextField();
		textField_12.setBounds(163, 610, 116, 22);
		...
		JLabel lblNewLabel_16 = new JLabel("Change code");
		lblNewLabel_16.setBounds(69, 613, 82, 16);
